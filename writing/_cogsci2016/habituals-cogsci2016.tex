...
None of the participants were used in Expt.~3.
The experiment took 4 minutes on average on participants were compensated \$0.40 for their work.
...
The model decides if the habitual is a useful way to describe the person's behavior, taking into the listener's beliefs about how common the action is, the likely frequency of action, and the basic conversational principles to be truthful and informative.

To our knowledge, this is the first empirical evidence addressing the truth conditions of habitual sentences.
