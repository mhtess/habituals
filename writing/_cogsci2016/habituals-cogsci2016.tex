...
In Expts.~1 \& 2, we measure participants' prior expectations about the frequency with which an event occurs and explore the predictions of the model for when a habitual sentence becomes acceptable.
