...
For a given individual $I$ (e.g.~\textsc{Bill}) and an event or behavior $E$ (e.g.~\textsc{smoking}), we refer to the rate at which an individual $I$ participates in an event $E$ for a given time window $t$ 
%that is $ \lambda_{t} = \int_{t} \mathbbm{1}_{I \in E}dt$, 
as the \emph{propensity} of $I$ doing $E$, denoted  $\lambda$.
