...
In Expt.~3a, we measure \emph{predictive frequency} when these causal factors are introduced as well as when past frequency alone is observed.
...
This will allow us to test whether habituals are best explained by as a speaker $S_2$ who wants to communicate past or predictive frequency.
...
Figure \ref{fig:tj3} (left) shows the predicted future frequency as a function of the past frequency given to the participant and the type of causal information given (in color; confidence intervals suppressed and jitter added for visual clarity). 
...
This may be due, in part, to an effect of the experiment context on participants: 
...
In both cases, we are able to explain the varying truth conditions of these kinds of sentences by using a pragmatically inferred threshold on
prevalence or propensity, respectively.
