...
Figure \ref{fig:tj3} (middle) shows the predicted future frequency as a function of the past frequency given to the participant and the type of conceptual information given (in color). 
We observe in the baseline condition that future frequency perfectly tracks with past frequency. This validates our assumption in our model of Expt.~2, where we assumed what the speaker was intending to communicate was the past frequency.
We also observe the preventative information appreciably decreasing and the enabling information increasing predicted frequency.
...
The model decides if a habitual is a useful way to describe a person's behavior, taking into the listener's prior  beliefs about the action --- how common it is and the likely frequency of action --- and the basic conversational principles to be truthful and informative.
We validate this model by eliciting felicity judgments for habitual sentences covering a wide range of activities with a wide range of experimentally manipulated frequencies of action.
