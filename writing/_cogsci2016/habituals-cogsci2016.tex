...
To increase expected variability, participants saw only the frequencies that led to the maximal and minimal endorsements of the habitual in Expt.~2. 
...
Scales, and scalar representations, provide a simple, general, and quantitative way to express truth conditions.

Generics are ubiquitous in everyday conversation and in child-direction speech \cite{Gelman2008} and are thought to be central to how concepts are developed \cite{Gelman2004}.
