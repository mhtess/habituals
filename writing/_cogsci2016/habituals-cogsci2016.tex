...
\begin{eqnarray}
P_{S_{2}}(u \mid \lambda) & \propto & \exp{(\alpha_2 \cdot \ln \int_{\tau} P_{L_{1}}(\lambda , \tau \mid u))}\label{eq:S2}\\
...
\begin{figure*}[t]
\centering
  \includegraphics[width=0.8\textwidth]{tj-scatters-3}
  \caption{
...
The Maximum A-Posteriori (MAP) value and 95\% highest probability density interval (HDI) for $\alpha_1$ is 5.7 [5.1,6.2] and \red{$\alpha_2$ is 5.7 [5.1,6.2]}.
