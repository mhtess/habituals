...
This can be done by observing white swans or by being presented in a pedagogical manner with the same evidence \cite{Markman1989, Shafto2012}.
More to the point, a helpful interlocutor could just tell you \emph{Swans are white}. 
This \emph{generic} sentence is a simple and convenient way to communicate the generalization \cite{Carlson1977, Leslie2008}. 
Similar simple sentences are used to communication generalizations about events--- these are called \emph{habituals} (e.g. \emph{Bill smokes cigarettes} generalizes the event of Bill smoking a cigarette over time; \citeNP{Carlson2005, Cohen1999}). 
Statements about causality can be thought of as generalizing a particular cause--effect instance (e.g. Bill getting cancer as a result of smoking) over time and space  (e.g. \emph{Smoking causes cancer}).
