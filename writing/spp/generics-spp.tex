...
This hard problem can be overcome by young children by merely observing instances of the category \cite{Markman1989} or by being shown the same evidence pedagogically \cite<e.g.>{Shafto2012}.
...
Similar, simple sentences are used to communication generalizations about events, called \emph{habituals} (e.g.  Bill smoking a cigarette can be generalized over time with \emph{Bill smokes cigarettes}; \citeNP{Carlson2005, Cohen1999}). 
