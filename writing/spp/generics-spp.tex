...
We argue that the core meaning of a generic or habitual sentence is simple but underspecified, and that general principles of pragmatic reasoning are responsible for establishing a precise meaning in context. 
Building on recent probabilistic models of language understanding, we provide a formal model for the evaluation of generic and habitual sentences. 
This model explains the puzzling flexibility in truth conditions in terms of diverse prior beliefs about properties or events.
...
Experiment 2 provides a conceptual replication with events and habitual sentences.
