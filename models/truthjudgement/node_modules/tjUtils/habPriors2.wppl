...
var tjData = mht.readCSV(fpath2+"tj-2.csv").data


var df_e = dataFrame(existData, ["val"])
var df_w = dataFrame(waitData, ["val"])
var df_tj = dataFrame(tjData, ["frequency", "logFreq"])
...
var priorModel = function(){
	...
	foreach(items, function(i){
		...
		// foreach(genders, function(g){
			...
			// query.add(i, 
			// 	discretizeLogNormalPrior(predictiveExistence, mu, sigma))

			query.add(i, [predictiveExistence, mu, sigma])
